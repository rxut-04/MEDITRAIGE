...
const ArtisticBackground = () => {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      // Using a solid color or skipping if image not found to avoid errors
      img.src = 'data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyBAMAAADsEZWCAAAAGFBMVEUAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAN1S96AAAAB3RSTlMAAAAAAAAAYv9jYQAAADBJREFUeF7t0EERAAAIA6BJ/6Y2vA0E9OnkZCO66Oioo6Ojo6Ojo6Ojo6Ojo6Ojo6OjI91zAgv/N38VAAAAAElFTkSuQmCC';
      img.onload = () => {
